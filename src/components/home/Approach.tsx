...
export function Approach() {
  ...
  useEffect(() => {
    if (!isHoveringSpline || !mounted) return;
  ...
  return (
    <section ref={sectionRef} className="h-screen w-full relative overflow-hidden bg-[#050510]" id="approach">
      ...
      {mounted && (
        <div
          ref={cursorRef}
          className={`fixed pointer-events-none z-[100] will-change-transform transition-opacity duration-200 ${isHoveringSpline ? "opacity-100" : "opacity-0"
            }`}
          style={{
            top: 0,
            left: 0,
